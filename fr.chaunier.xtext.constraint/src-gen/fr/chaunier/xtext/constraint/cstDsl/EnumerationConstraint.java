 ...
 * <ul>
 *   <li>{@link fr.chaunier.xtext.constraint.cstDsl.EnumerationConstraint#getUsage <em>Usage</em>}</li>
 *   <li>{@link fr.chaunier.xtext.constraint.cstDsl.EnumerationConstraint#getFixeLen <em>Fixe Len</em>}</li>
 *   <li>{@link fr.chaunier.xtext.constraint.cstDsl.EnumerationConstraint#isHasDefault <em>Has Default</em>}</li>
 *   <li>{@link fr.chaunier.xtext.constraint.cstDsl.EnumerationConstraint#getDefaultValueAsString <em>Default Value As String</em>}</li>
 * </ul>
 * </p>
 *
...
public interface EnumerationConstraint extends Constraint
{
   ...
   * @see fr.chaunier.xtext.constraint.cstDsl.CstDslPackage#getEnumerationConstraint_Usage()
   * @model
   * @generated
   */
  EnumUsage getUsage();
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.constraint.cstDsl.EnumerationConstraint#getUsage <em>Usage</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setFixeLen(int)
   * @see fr.chaunier.xtext.constraint.cstDsl.CstDslPackage#getEnumerationConstraint_FixeLen()
   * @model
   * @generated
   */
  int getFixeLen();
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.constraint.cstDsl.EnumerationConstraint#getFixeLen <em>Fixe Len</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.chaunier.xtext.constraint.cstDsl.CstDslPackage#getEnumerationConstraint_HasDefault()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.constraint.cstDsl.EnumerationConstraint#isHasDefault <em>Has Default</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.chaunier.xtext.constraint.cstDsl.CstDslPackage#getEnumerationConstraint_DefaultValueAsString()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.constraint.cstDsl.EnumerationConstraint#getDefaultValueAsString <em>Default Value As String</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
