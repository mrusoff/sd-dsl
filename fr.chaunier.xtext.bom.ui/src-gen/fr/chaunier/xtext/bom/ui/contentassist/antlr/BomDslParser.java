		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStringConstraintAccess().getGroup_7(), "rule__StringConstraint__Group_7__0");
					...
					put(grammarAccess.getIntegerConstraintAccess().getGroup_7(), "rule__IntegerConstraint__Group_7__0");
					...
					put(grammarAccess.getDecimalConstraintAccess().getGroup_6(), "rule__DecimalConstraint__Group_6__0");
					put(grammarAccess.getDecimalConstraintAccess().getGroup_7(), "rule__DecimalConstraint__Group_7__0");
					...
					put(grammarAccess.getStringConstraintAccess().getIsFixedAssignment_2_0(), "rule__StringConstraint__IsFixedAssignment_2_0");
					put(grammarAccess.getStringConstraintAccess().getFixedValueAssignment_2_1(), "rule__StringConstraint__FixedValueAssignment_2_1");
					put(grammarAccess.getStringConstraintAccess().getMinLenAssignment_3_1(), "rule__StringConstraint__MinLenAssignment_3_1");
					put(grammarAccess.getStringConstraintAccess().getMaxLenAssignment_4_1(), "rule__StringConstraint__MaxLenAssignment_4_1");
					put(grammarAccess.getStringConstraintAccess().getFixeLenAssignment_5_1(), "rule__StringConstraint__FixeLenAssignment_5_1");
					put(grammarAccess.getStringConstraintAccess().getIsXSDAttAssignment_6(), "rule__StringConstraint__IsXSDAttAssignment_6");
					put(grammarAccess.getStringConstraintAccess().getRegularExpressionAssignment_7_1(), "rule__StringConstraint__RegularExpressionAssignment_7_1");
					...
					put(grammarAccess.getIntegerConstraintAccess().getIsFixedAssignment_2_0(), "rule__IntegerConstraint__IsFixedAssignment_2_0");
					put(grammarAccess.getIntegerConstraintAccess().getFixedValueAssignment_2_1(), "rule__IntegerConstraint__FixedValueAssignment_2_1");
					put(grammarAccess.getIntegerConstraintAccess().getMinValueAssignment_3_1(), "rule__IntegerConstraint__MinValueAssignment_3_1");
					put(grammarAccess.getIntegerConstraintAccess().getMaxValueAssignment_4_1(), "rule__IntegerConstraint__MaxValueAssignment_4_1");
					put(grammarAccess.getIntegerConstraintAccess().getMaxLenAssignment_5_1(), "rule__IntegerConstraint__MaxLenAssignment_5_1");
					put(grammarAccess.getIntegerConstraintAccess().getFixeLenAssignment_6_1(), "rule__IntegerConstraint__FixeLenAssignment_6_1");
					put(grammarAccess.getIntegerConstraintAccess().getPaddleAssignment_7_1(), "rule__IntegerConstraint__PaddleAssignment_7_1");
					put(grammarAccess.getIntegerConstraintAccess().getIsXSDAttAssignment_8(), "rule__IntegerConstraint__IsXSDAttAssignment_8");
					put(grammarAccess.getDecimalConstraintAccess().getConstraintAssignment_0(), "rule__DecimalConstraint__ConstraintAssignment_0");
					put(grammarAccess.getDecimalConstraintAccess().getHasDefaultAssignment_1_0(), "rule__DecimalConstraint__HasDefaultAssignment_1_0");
					put(grammarAccess.getDecimalConstraintAccess().getDefaultValueAssignment_1_1(), "rule__DecimalConstraint__DefaultValueAssignment_1_1");
					put(grammarAccess.getDecimalConstraintAccess().getIsFixedAssignment_2_0(), "rule__DecimalConstraint__IsFixedAssignment_2_0");
					put(grammarAccess.getDecimalConstraintAccess().getFixedValueAssignment_2_1(), "rule__DecimalConstraint__FixedValueAssignment_2_1");
					put(grammarAccess.getDecimalConstraintAccess().getMinValueAssignment_3_1(), "rule__DecimalConstraint__MinValueAssignment_3_1");
					put(grammarAccess.getDecimalConstraintAccess().getMaxValueAssignment_4_1(), "rule__DecimalConstraint__MaxValueAssignment_4_1");
					put(grammarAccess.getDecimalConstraintAccess().getMaxLenAssignment_5_1(), "rule__DecimalConstraint__MaxLenAssignment_5_1");
					put(grammarAccess.getDecimalConstraintAccess().getFixeLenAssignment_6_1(), "rule__DecimalConstraint__FixeLenAssignment_6_1");
					put(grammarAccess.getDecimalConstraintAccess().getPaddleAssignment_7_1(), "rule__DecimalConstraint__PaddleAssignment_7_1");
					put(grammarAccess.getDecimalConstraintAccess().getIsXSDAttAssignment_8(), "rule__DecimalConstraint__IsXSDAttAssignment_8");
