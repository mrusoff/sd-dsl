 ...
 * <ul>
 *   <li>{@link fr.chaunier.xtext.omcst.om.omcstDsl.impl.EnumerationConstraintImpl#getUsage <em>Usage</em>}</li>
 *   <li>{@link fr.chaunier.xtext.omcst.om.omcstDsl.impl.EnumerationConstraintImpl#getFixeLen <em>Fixe Len</em>}</li>
 *   <li>{@link fr.chaunier.xtext.omcst.om.omcstDsl.impl.EnumerationConstraintImpl#isHasDefault <em>Has Default</em>}</li>
 *   <li>{@link fr.chaunier.xtext.omcst.om.omcstDsl.impl.EnumerationConstraintImpl#getDefaultValueAsString <em>Default Value As String</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationConstraintImpl extends ConstraintImpl implements EnumerationConstraint
{
  ...
  {
    return OmcstDslPackage.Literals.ENUMERATION_CONSTRAINT;
  }
  ...
  public void setUsage(EnumUsage newUsage)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OmcstDslPackage.ENUMERATION_CONSTRAINT__USAGE, oldUsage, usage));
  }
  ...
  public void setFixeLen(int newFixeLen)
  {
    ...
    fixeLen = newFixeLen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OmcstDslPackage.ENUMERATION_CONSTRAINT__FIXE_LEN, oldFixeLen, fixeLen));
  }
  ...
  public void setHasDefault(boolean newHasDefault)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OmcstDslPackage.ENUMERATION_CONSTRAINT__HAS_DEFAULT, oldHasDefault, hasDefault));
  }
  ...
  public void setDefaultValueAsString(String newDefaultValueAsString)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OmcstDslPackage.ENUMERATION_CONSTRAINT__DEFAULT_VALUE_AS_STRING, oldDefaultValueAsString, defaultValueAsString));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OmcstDslPackage.ENUMERATION_CONSTRAINT__USAGE:
        return getUsage();
      case OmcstDslPackage.ENUMERATION_CONSTRAINT__FIXE_LEN:
        return getFixeLen();
      case OmcstDslPackage.ENUMERATION_CONSTRAINT__HAS_DEFAULT:
        return isHasDefault();
      case OmcstDslPackage.ENUMERATION_CONSTRAINT__DEFAULT_VALUE_AS_STRING:
