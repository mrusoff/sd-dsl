 ...
 * <ul>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.TypeRef#getReferenced <em>Referenced</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.TypeRef#isMulti <em>Multi</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.TypeRef#isOption <em>Option</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.chaunier.xtext.bom.bomDsl.BomDslPackage#getTypeRef()
 * @model
 * @generated
 */
public interface TypeRef extends EObject
{
   ...
   * @see fr.chaunier.xtext.bom.bomDsl.BomDslPackage#getTypeRef_Referenced()
   * @model
   * @generated
   */
  Type getReferenced();
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.bom.bomDsl.TypeRef#getReferenced <em>Referenced</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.chaunier.xtext.bom.bomDsl.BomDslPackage#getTypeRef_Multi()
   * @model
   * @generated
   */
  boolean isMulti();
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.bom.bomDsl.TypeRef#isMulti <em>Multi</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.chaunier.xtext.bom.bomDsl.BomDslPackage#getTypeRef_Option()
   * @model
   * @generated
   */
  boolean isOption();
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.bom.bomDsl.TypeRef#isOption <em>Option</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
