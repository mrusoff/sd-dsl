...
public class MapDslInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	public Injector getInjector() {
		if (injector == null) {
			this.injector = new MapDslStandaloneSetup().createInjectorAndDoEMFRegistration();
		}
		return injector;
	}
