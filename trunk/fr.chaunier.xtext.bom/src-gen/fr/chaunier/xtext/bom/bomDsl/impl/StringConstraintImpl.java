 ...
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.StringConstraintImpl#getConstraintRef <em>Constraint Ref</em>}</li>
...
public class StringConstraintImpl extends ConstraintImpl implements StringConstraint
{
  ...
  public NotificationChain basicSetConstraintRef(AllConstraint newConstraintRef, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BomDslPackage.STRING_CONSTRAINT__CONSTRAINT_REF, oldConstraintRef, newConstraintRef);
  ...
  public void setConstraintRef(AllConstraint newConstraintRef)
  {
    if (newConstraintRef != constraintRef)
    {
      ...
      if (constraintRef != null)
        msgs = ((InternalEObject)constraintRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BomDslPackage.STRING_CONSTRAINT__CONSTRAINT_REF, null, msgs);
      if (newConstraintRef != null)
        msgs = ((InternalEObject)newConstraintRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BomDslPackage.STRING_CONSTRAINT__CONSTRAINT_REF, null, msgs);
      msgs = basicSetConstraintRef(newConstraintRef, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.STRING_CONSTRAINT__CONSTRAINT_REF, newConstraintRef, newConstraintRef));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BomDslPackage.STRING_CONSTRAINT__CONSTRAINT_REF:
