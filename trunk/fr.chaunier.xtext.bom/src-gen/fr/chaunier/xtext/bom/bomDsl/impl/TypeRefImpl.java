 ...
 * <ul>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.TypeRefImpl#getReferenced <em>Referenced</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.TypeRefImpl#isMulti <em>Multi</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.TypeRefImpl#isOption <em>Option</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeRefImpl extends MinimalEObjectImpl.Container implements TypeRef
{
  ...
  {
    return BomDslPackage.Literals.TYPE_REF;
  }
    ...
    if (referenced != null && referenced.eIsProxy())
    {
      ...
      if (referenced != oldReferenced)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, BomDslPackage.TYPE_REF__REFERENCED, oldReferenced, referenced));
      }
    }
    return referenced;
  }
  ...
  public void setReferenced(Type newReferenced)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.TYPE_REF__REFERENCED, oldReferenced, referenced));
  }
  ...
  public void setMulti(boolean newMulti)
  {
    ...
    multi = newMulti;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.TYPE_REF__MULTI, oldMulti, multi));
  }
  ...
  public void setOption(boolean newOption)
  {
    ...
    option = newOption;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.TYPE_REF__OPTION, oldOption, option));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BomDslPackage.TYPE_REF__REFERENCED:
        if (resolve) return getReferenced();
        return basicGetReferenced();
      case BomDslPackage.TYPE_REF__MULTI:
        return isMulti();
      case BomDslPackage.TYPE_REF__OPTION:
        return isOption();
    }
