 ...
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.DecimalConstraint#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.DecimalConstraint#isIsFixed <em>Is Fixed</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.DecimalConstraint#getFixedValue <em>Fixed Value</em>}</li>
 ...
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.DecimalConstraint#isIsXSDAtt <em>Is XSD Att</em>}</li>
 * </ul>
 * </p>
 *
...
public interface DecimalConstraint extends Constraint
{
   ...
   * @see fr.chaunier.xtext.bom.bomDsl.BomDslPackage#getDecimalConstraint_DefaultValue()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.bom.bomDsl.DecimalConstraint#getDefaultValue <em>Default Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.chaunier.xtext.bom.bomDsl.BomDslPackage#getDecimalConstraint_IsFixed()
   * @model
   * @generated
   */
  boolean isIsFixed();
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.bom.bomDsl.DecimalConstraint#isIsFixed <em>Is Fixed</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.chaunier.xtext.bom.bomDsl.BomDslPackage#getDecimalConstraint_FixedValue()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.bom.bomDsl.DecimalConstraint#getFixedValue <em>Fixed Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.chaunier.xtext.bom.bomDsl.BomDslPackage#getDecimalConstraint_IsXSDAtt()
   * @model
   * @generated
   */
  boolean isIsXSDAtt();
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.bom.bomDsl.DecimalConstraint#isIsXSDAtt <em>Is XSD Att</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
