 ...
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.StringConstraint#getConstraintRef <em>Constraint Ref</em>}</li>
...
public interface StringConstraint extends Constraint
{
   ...
   * @see fr.chaunier.xtext.bom.bomDsl.BomDslPackage#getStringConstraint_ConstraintRef()
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.bom.bomDsl.StringConstraint#getConstraintRef <em>Constraint Ref</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
