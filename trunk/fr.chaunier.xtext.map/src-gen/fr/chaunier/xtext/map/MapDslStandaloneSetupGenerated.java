...
public class MapDslStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new fr.chaunier.xtext.map.MapDslRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.chaunier.fr/xtext/map/MapDsl")) {
		EPackage.Registry.INSTANCE.put("http://www.chaunier.fr/xtext/map/MapDsl", fr.chaunier.xtext.map.mapDsl.MapDslPackage.eINSTANCE);
	}
