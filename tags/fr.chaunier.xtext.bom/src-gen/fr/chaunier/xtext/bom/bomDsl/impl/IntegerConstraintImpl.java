 ...
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.IntegerConstraintImpl#getConstraintRef <em>Constraint Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntegerConstraintImpl extends ConstraintImpl implements IntegerConstraint
{
  ...
  public NotificationChain basicSetConstraintRef(NumberConstraint newConstraintRef, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BomDslPackage.INTEGER_CONSTRAINT__CONSTRAINT_REF, oldConstraintRef, newConstraintRef);
  ...
  public void setConstraintRef(NumberConstraint newConstraintRef)
  {
    if (newConstraintRef != constraintRef)
    {
      ...
      if (constraintRef != null)
        msgs = ((InternalEObject)constraintRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BomDslPackage.INTEGER_CONSTRAINT__CONSTRAINT_REF, null, msgs);
      if (newConstraintRef != null)
        msgs = ((InternalEObject)newConstraintRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BomDslPackage.INTEGER_CONSTRAINT__CONSTRAINT_REF, null, msgs);
      msgs = basicSetConstraintRef(newConstraintRef, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.INTEGER_CONSTRAINT__CONSTRAINT_REF, newConstraintRef, newConstraintRef));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BomDslPackage.INTEGER_CONSTRAINT__CONSTRAINT_REF:
