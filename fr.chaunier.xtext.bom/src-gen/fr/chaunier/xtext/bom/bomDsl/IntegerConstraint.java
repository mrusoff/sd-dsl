...
public interface IntegerConstraint extends Constraint
{
   ...
   * @see fr.chaunier.xtext.bom.bomDsl.BomDslPackage#getIntegerConstraint_DefaultValue()
   * @model
   * @generated
   */
  int getDefaultValue();
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.bom.bomDsl.IntegerConstraint#getDefaultValue <em>Default Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setMinValue(int)
   * @see fr.chaunier.xtext.bom.bomDsl.BomDslPackage#getIntegerConstraint_MinValue()
   * @model
   * @generated
   */
  int getMinValue();
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.bom.bomDsl.IntegerConstraint#getMinValue <em>Min Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setMaxValue(int)
   * @see fr.chaunier.xtext.bom.bomDsl.BomDslPackage#getIntegerConstraint_MaxValue()
   * @model
   * @generated
   */
  int getMaxValue();
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.bom.bomDsl.IntegerConstraint#getMaxValue <em>Max Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setMaxLen(int)
   * @see fr.chaunier.xtext.bom.bomDsl.BomDslPackage#getIntegerConstraint_MaxLen()
   * @model
   * @generated
   */
  int getMaxLen();
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.bom.bomDsl.IntegerConstraint#getMaxLen <em>Max Len</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setFixeLen(int)
   * @see fr.chaunier.xtext.bom.bomDsl.BomDslPackage#getIntegerConstraint_FixeLen()
   * @model
   * @generated
   */
  int getFixeLen();
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.bom.bomDsl.IntegerConstraint#getFixeLen <em>Fixe Len</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.chaunier.xtext.bom.bomDsl.BomDslPackage#getIntegerConstraint_Paddle()
   * @model
   * @generated
   */
  String getPaddle();
  ...
  /**
   * Sets the value of the '{@link fr.chaunier.xtext.bom.bomDsl.IntegerConstraint#getPaddle <em>Paddle</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
