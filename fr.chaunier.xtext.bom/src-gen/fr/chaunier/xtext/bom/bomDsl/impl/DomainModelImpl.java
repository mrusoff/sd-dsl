 ...
 * <ul>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.DomainModelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DomainModelImpl extends MinimalEObjectImpl.Container implements DomainModel
{
  ...
  {
    return BomDslPackage.Literals.DOMAIN_MODEL;
  }
  ...
  public EList<AbstractElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<AbstractElement>(AbstractElement.class, this, BomDslPackage.DOMAIN_MODEL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BomDslPackage.DOMAIN_MODEL__ELEMENTS:
