 ...
 * <ul>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.AllConstraintImpl#isHasDefault <em>Has Default</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.AllConstraintImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.AllConstraintImpl#isIsFixed <em>Is Fixed</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.AllConstraintImpl#getFixedValue <em>Fixed Value</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.AllConstraintImpl#getMinLen <em>Min Len</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.AllConstraintImpl#getMaxLen <em>Max Len</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.AllConstraintImpl#getFixeLen <em>Fixe Len</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.AllConstraintImpl#getPaddle <em>Paddle</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.AllConstraintImpl#isNullable <em>Nullable</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.AllConstraintImpl#isDerived <em>Derived</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.AllConstraintImpl#isWritable <em>Writable</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.AllConstraintImpl#isIsXSDAtt <em>Is XSD Att</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AllConstraintImpl extends MinimalEObjectImpl.Container implements AllConstraint
{
  ...
  {
    return BomDslPackage.Literals.ALL_CONSTRAINT;
  }
  ...
  public void setHasDefault(boolean newHasDefault)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.ALL_CONSTRAINT__HAS_DEFAULT, oldHasDefault, hasDefault));
  }
  ...
  public void setDefaultValue(String newDefaultValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.ALL_CONSTRAINT__DEFAULT_VALUE, oldDefaultValue, defaultValue));
  }
  ...
  public void setIsFixed(boolean newIsFixed)
  {
    ...
    isFixed = newIsFixed;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.ALL_CONSTRAINT__IS_FIXED, oldIsFixed, isFixed));
  }
  ...
  public void setFixedValue(String newFixedValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.ALL_CONSTRAINT__FIXED_VALUE, oldFixedValue, fixedValue));
  }
  ...
  public void setMinLen(int newMinLen)
  {
    ...
    minLen = newMinLen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.ALL_CONSTRAINT__MIN_LEN, oldMinLen, minLen));
  }
  ...
  public void setMaxLen(int newMaxLen)
  {
    ...
    maxLen = newMaxLen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.ALL_CONSTRAINT__MAX_LEN, oldMaxLen, maxLen));
  }
  ...
  public void setFixeLen(int newFixeLen)
  {
    ...
    fixeLen = newFixeLen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.ALL_CONSTRAINT__FIXE_LEN, oldFixeLen, fixeLen));
  }
  ...
  public void setPaddle(String newPaddle)
  {
    ...
    paddle = newPaddle;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.ALL_CONSTRAINT__PADDLE, oldPaddle, paddle));
  }
  ...
  public void setNullable(boolean newNullable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.ALL_CONSTRAINT__NULLABLE, oldNullable, nullable));
  }
  ...
  public void setDerived(boolean newDerived)
  {
    ...
    derived = newDerived;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.ALL_CONSTRAINT__DERIVED, oldDerived, derived));
  }
  ...
  public void setWritable(boolean newWritable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.ALL_CONSTRAINT__WRITABLE, oldWritable, writable));
  }
  ...
  public void setIsXSDAtt(boolean newIsXSDAtt)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.ALL_CONSTRAINT__IS_XSD_ATT, oldIsXSDAtt, isXSDAtt));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BomDslPackage.ALL_CONSTRAINT__HAS_DEFAULT:
        return isHasDefault();
      case BomDslPackage.ALL_CONSTRAINT__DEFAULT_VALUE:
        return getDefaultValue();
      case BomDslPackage.ALL_CONSTRAINT__IS_FIXED:
        return isIsFixed();
      case BomDslPackage.ALL_CONSTRAINT__FIXED_VALUE:
        return getFixedValue();
      case BomDslPackage.ALL_CONSTRAINT__MIN_LEN:
        return getMinLen();
      case BomDslPackage.ALL_CONSTRAINT__MAX_LEN:
        return getMaxLen();
      case BomDslPackage.ALL_CONSTRAINT__FIXE_LEN:
        return getFixeLen();
      case BomDslPackage.ALL_CONSTRAINT__PADDLE:
        return getPaddle();
      case BomDslPackage.ALL_CONSTRAINT__NULLABLE:
        return isNullable();
      case BomDslPackage.ALL_CONSTRAINT__DERIVED:
        return isDerived();
      case BomDslPackage.ALL_CONSTRAINT__WRITABLE:
        return isWritable();
      case BomDslPackage.ALL_CONSTRAINT__IS_XSD_ATT:
        return isIsXSDAtt();
    }
