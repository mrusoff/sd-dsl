 ...
 * <ul>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.NumberConstraintImpl#getMinValue <em>Min Value</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.NumberConstraintImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.NumberConstraintImpl#isHasDefault <em>Has Default</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.NumberConstraintImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.NumberConstraintImpl#isIsFixed <em>Is Fixed</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.NumberConstraintImpl#getFixedValue <em>Fixed Value</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.NumberConstraintImpl#getMinLen <em>Min Len</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.NumberConstraintImpl#getMaxLen <em>Max Len</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.NumberConstraintImpl#getFixeLen <em>Fixe Len</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.NumberConstraintImpl#getPaddle <em>Paddle</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.NumberConstraintImpl#isNullable <em>Nullable</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.NumberConstraintImpl#isDerived <em>Derived</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.NumberConstraintImpl#isWritable <em>Writable</em>}</li>
 *   <li>{@link fr.chaunier.xtext.bom.bomDsl.impl.NumberConstraintImpl#isIsXSDAtt <em>Is XSD Att</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NumberConstraintImpl extends MinimalEObjectImpl.Container implements NumberConstraint
{
  ...
  {
    return BomDslPackage.Literals.NUMBER_CONSTRAINT;
  }
  ...
  public void setMinValue(int newMinValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.NUMBER_CONSTRAINT__MIN_VALUE, oldMinValue, minValue));
  }
  ...
  public void setMaxValue(int newMaxValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.NUMBER_CONSTRAINT__MAX_VALUE, oldMaxValue, maxValue));
  }
  ...
  public void setHasDefault(boolean newHasDefault)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.NUMBER_CONSTRAINT__HAS_DEFAULT, oldHasDefault, hasDefault));
  }
  ...
  public void setDefaultValue(String newDefaultValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.NUMBER_CONSTRAINT__DEFAULT_VALUE, oldDefaultValue, defaultValue));
  }
  ...
  public void setIsFixed(boolean newIsFixed)
  {
    ...
    isFixed = newIsFixed;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.NUMBER_CONSTRAINT__IS_FIXED, oldIsFixed, isFixed));
  }
  ...
  public void setFixedValue(String newFixedValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.NUMBER_CONSTRAINT__FIXED_VALUE, oldFixedValue, fixedValue));
  }
  ...
  public void setMinLen(int newMinLen)
  {
    ...
    minLen = newMinLen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.NUMBER_CONSTRAINT__MIN_LEN, oldMinLen, minLen));
  }
  ...
  public void setMaxLen(int newMaxLen)
  {
    ...
    maxLen = newMaxLen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.NUMBER_CONSTRAINT__MAX_LEN, oldMaxLen, maxLen));
  }
  ...
  public void setFixeLen(int newFixeLen)
  {
    ...
    fixeLen = newFixeLen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.NUMBER_CONSTRAINT__FIXE_LEN, oldFixeLen, fixeLen));
  }
  ...
  public void setPaddle(String newPaddle)
  {
    ...
    paddle = newPaddle;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.NUMBER_CONSTRAINT__PADDLE, oldPaddle, paddle));
  }
  ...
  public void setNullable(boolean newNullable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.NUMBER_CONSTRAINT__NULLABLE, oldNullable, nullable));
  }
  ...
  public void setDerived(boolean newDerived)
  {
    ...
    derived = newDerived;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.NUMBER_CONSTRAINT__DERIVED, oldDerived, derived));
  }
  ...
  public void setWritable(boolean newWritable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.NUMBER_CONSTRAINT__WRITABLE, oldWritable, writable));
  }
  ...
  public void setIsXSDAtt(boolean newIsXSDAtt)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BomDslPackage.NUMBER_CONSTRAINT__IS_XSD_ATT, oldIsXSDAtt, isXSDAtt));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BomDslPackage.NUMBER_CONSTRAINT__MIN_VALUE:
        return getMinValue();
      case BomDslPackage.NUMBER_CONSTRAINT__MAX_VALUE:
        return getMaxValue();
      case BomDslPackage.NUMBER_CONSTRAINT__HAS_DEFAULT:
        return isHasDefault();
      case BomDslPackage.NUMBER_CONSTRAINT__DEFAULT_VALUE:
        return getDefaultValue();
      case BomDslPackage.NUMBER_CONSTRAINT__IS_FIXED:
        return isIsFixed();
      case BomDslPackage.NUMBER_CONSTRAINT__FIXED_VALUE:
        return getFixedValue();
      case BomDslPackage.NUMBER_CONSTRAINT__MIN_LEN:
        return getMinLen();
      case BomDslPackage.NUMBER_CONSTRAINT__MAX_LEN:
        return getMaxLen();
      case BomDslPackage.NUMBER_CONSTRAINT__FIXE_LEN:
        return getFixeLen();
      case BomDslPackage.NUMBER_CONSTRAINT__PADDLE:
        return getPaddle();
      case BomDslPackage.NUMBER_CONSTRAINT__NULLABLE:
        return isNullable();
      case BomDslPackage.NUMBER_CONSTRAINT__DERIVED:
        return isDerived();
      case BomDslPackage.NUMBER_CONSTRAINT__WRITABLE:
        return isWritable();
      case BomDslPackage.NUMBER_CONSTRAINT__IS_XSD_ATT:
        return isIsXSDAtt();
    }
