 ...
 * <ul>
 *   <li>{@link fr.chaunier.xtext.om.omDsl.impl.ReferenceImpl#getOpposite <em>Opposite</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReferenceImpl extends StructuralFeatureImpl implements Reference
{
  ...
  {
    return OmDslPackage.Literals.REFERENCE;
  }
    ...
    if (opposite != null && opposite.eIsProxy())
    {
      ...
      if (opposite != oldOpposite)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, OmDslPackage.REFERENCE__OPPOSITE, oldOpposite, opposite));
      }
    }
    return opposite;
  }
  ...
  public void setOpposite(Reference newOpposite)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OmDslPackage.REFERENCE__OPPOSITE, oldOpposite, opposite));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OmDslPackage.REFERENCE__OPPOSITE:
