 ...
 * <ul>
 *   <li>{@link fr.chaunier.xtext.om.omDsl.impl.DomainModelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DomainModelImpl extends MinimalEObjectImpl.Container implements DomainModel
{
  ...
  {
    return OmDslPackage.Literals.DOMAIN_MODEL;
  }
  ...
  public EList<AbstractElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<AbstractElement>(AbstractElement.class, this, OmDslPackage.DOMAIN_MODEL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case OmDslPackage.DOMAIN_MODEL__ELEMENTS:
