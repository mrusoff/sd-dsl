 ...
 * <ul>
 *   <li>{@link fr.chaunier.xtext.om.omDsl.Enumeration#getEnumerationLiterals <em>Enumeration Literals</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.chaunier.xtext.om.omDsl.OmDslPackage#getEnumeration()
 * @model
 * @generated
 */
public interface Enumeration extends Type
{
   ...
   * The list contents are of type {@link fr.chaunier.xtext.om.omDsl.EnumerationLiteral}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see fr.chaunier.xtext.om.omDsl.OmDslPackage#getEnumeration_EnumerationLiterals()
