    ...
    for (Entity entity : _filter) {
      {
        ...
        String _xmlFileName = this.generatorExtensions.xmlFileName(entity);
        StringConcatenation _compileXml = this.compileXml(entity);
        fsa.generateFile(_xmlFileName, _compileXml);
      }
    }
  }
