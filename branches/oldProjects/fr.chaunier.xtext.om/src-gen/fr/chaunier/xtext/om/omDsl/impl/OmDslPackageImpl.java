...
import fr.chaunier.xtext.om.omDsl.OmDslFactory;
...
import fr.chaunier.xtext.om.omDsl.TypedElement;
import fr.chaunier.xtext.om.omDsl.Visibility;
 ...
 * @generated
 */
public class OmDslPackageImpl extends EPackageImpl implements OmDslPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.chaunier.xtext.om.omDsl.OmDslPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private OmDslPackageImpl()
  {
    super(eNS_URI, OmDslFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link OmDslPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static OmDslPackage init()
  {
    if (isInited) return (OmDslPackage)EPackage.Registry.INSTANCE.getEPackage(OmDslPackage.eNS_URI);

    // Obtain or create and register package
    OmDslPackageImpl theOmDslPackage = (OmDslPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof OmDslPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new OmDslPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theOmDslPackage.createPackageContents();

    // Initialize created meta-data
    theOmDslPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theOmDslPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(OmDslPackage.eNS_URI, theOmDslPackage);
    return theOmDslPackage;
  }
   ...
   * @generated
   */
  public EReference getStructuralFeature_Annotations()
  {
   ...
   * @generated
   */
  public OmDslFactory getOmDslFactory()
  {
    return (OmDslFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(dataTypeEClass, DATA_TYPE__ANNOTATIONS);
    ...
    createEReference(structuralFeatureEClass, STRUCTURAL_FEATURE__ANNOTATIONS);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getDataType_Annotations(), this.getAnnotation(), null, "annotations", null, 0, -1, DataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getStructuralFeature_Annotations(), this.getAnnotation(), null, "annotations", null, 0, -1, StructuralFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
