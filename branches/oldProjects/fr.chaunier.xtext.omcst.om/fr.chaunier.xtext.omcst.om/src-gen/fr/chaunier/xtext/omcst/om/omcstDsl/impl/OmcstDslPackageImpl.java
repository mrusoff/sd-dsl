...
import fr.chaunier.xtext.omcst.om.omcstDsl.AttributeType;
...
import fr.chaunier.xtext.omcst.om.omcstDsl.EnumUsage;
...
import fr.chaunier.xtext.omcst.om.omcstDsl.OmcstDslFactory;
...
import fr.chaunier.xtext.omcst.om.omcstDsl.TypedElement;
 ...
 * @generated
 */
public class OmcstDslPackageImpl extends EPackageImpl implements OmcstDslPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  private EClass xsdElementEClass = null;
   ...
   * @see fr.chaunier.xtext.omcst.om.omcstDsl.OmcstDslPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private OmcstDslPackageImpl()
  {
    super(eNS_URI, OmcstDslFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link OmcstDslPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static OmcstDslPackage init()
  {
    if (isInited) return (OmcstDslPackage)EPackage.Registry.INSTANCE.getEPackage(OmcstDslPackage.eNS_URI);

    // Obtain or create and register package
    OmcstDslPackageImpl theOmcstDslPackage = (OmcstDslPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof OmcstDslPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new OmcstDslPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theOmcstDslPackage.createPackageContents();

    // Initialize created meta-data
    theOmcstDslPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theOmcstDslPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(OmcstDslPackage.eNS_URI, theOmcstDslPackage);
    return theOmcstDslPackage;
  }
   ...
   * @generated
   */
  public EReference getXsdElement_XsdElement()
  {
    return (EReference)xsdElementEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getPackageDeclaration_Anno()
  {
   ...
   * @generated
   */
  public EReference getDataType_Anno()
  {
   ...
   * @generated
   */
  public EReference getEntity_Anno()
  {
   ...
   * @generated
   */
  public EReference getStructuralFeature_Anno()
  {
  ...
  {
    return (EAttribute)dateTimeConstraintEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public OmcstDslFactory getOmcstDslFactory()
  {
    return (OmcstDslFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    xsdElementEClass = createEClass(XSD_ELEMENT);
    createEReference(xsdElementEClass, XSD_ELEMENT__XSD_ELEMENT);
    ...
    createEReference(packageDeclarationEClass, PACKAGE_DECLARATION__ANNO);
    ...
    createEReference(dataTypeEClass, DATA_TYPE__ANNO);

    entityEClass = createEClass(ENTITY);
    createEAttribute(entityEClass, ENTITY__ENTITY_TYPE);
    createEReference(entityEClass, ENTITY__SUPER_TYPE);
    createEReference(entityEClass, ENTITY__ANNO);
    ...
    createEReference(structuralFeatureEClass, STRUCTURAL_FEATURE__ANNO);
  ...
  public void initializePackageContents()
  {
    ...
    xsdElementEClass.getESuperTypes().add(this.getAbstractElement());
    ...
    initEClass(xsdElementEClass, XsdElement.class, "XsdElement", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getXsdElement_XsdElement(), this.getEntity(), null, "xsdElement", null, 0, 1, XsdElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getPackageDeclaration_Anno(), this.getAnnotations(), null, "anno", null, 0, 1, PackageDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDataType_Constraint(), this.getConstraint(), null, "constraint", null, 0, 1, DataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDataType_Anno(), this.getAnnotations(), null, "anno", null, 0, 1, DataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getEntity_Anno(), this.getAnnotations(), null, "anno", null, 0, 1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getStructuralFeature_Anno(), this.getAnnotations(), null, "anno", null, 0, 1, StructuralFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
