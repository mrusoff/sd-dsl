 ...
 * <ul>
 *   <li>{@link fr.chaunier.xtext.omcst.om.omcstDsl.impl.DecimalConstraintImpl#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link fr.chaunier.xtext.omcst.om.omcstDsl.impl.DecimalConstraintImpl#getConstraintRef <em>Constraint Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DecimalConstraintImpl extends ConstraintImpl implements DecimalConstraint
{
  ...
  {
    return OmcstDslPackage.Literals.DECIMAL_CONSTRAINT;
  }
  ...
  public void setConstraint(String newConstraint)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OmcstDslPackage.DECIMAL_CONSTRAINT__CONSTRAINT, oldConstraint, constraint));
  }
  ...
  public NotificationChain basicSetConstraintRef(NumberConstraint newConstraintRef, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmcstDslPackage.DECIMAL_CONSTRAINT__CONSTRAINT_REF, oldConstraintRef, newConstraintRef);
  ...
  public void setConstraintRef(NumberConstraint newConstraintRef)
  {
    if (newConstraintRef != constraintRef)
    {
      ...
      if (constraintRef != null)
        msgs = ((InternalEObject)constraintRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmcstDslPackage.DECIMAL_CONSTRAINT__CONSTRAINT_REF, null, msgs);
      if (newConstraintRef != null)
        msgs = ((InternalEObject)newConstraintRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmcstDslPackage.DECIMAL_CONSTRAINT__CONSTRAINT_REF, null, msgs);
      msgs = basicSetConstraintRef(newConstraintRef, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OmcstDslPackage.DECIMAL_CONSTRAINT__CONSTRAINT_REF, newConstraintRef, newConstraintRef));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case OmcstDslPackage.DECIMAL_CONSTRAINT__CONSTRAINT_REF:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OmcstDslPackage.DECIMAL_CONSTRAINT__CONSTRAINT:
