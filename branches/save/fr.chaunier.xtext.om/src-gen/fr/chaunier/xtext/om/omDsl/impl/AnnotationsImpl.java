 ...
 * <ul>
 *   <li>{@link fr.chaunier.xtext.om.omDsl.impl.AnnotationsImpl#getAnnotations <em>Annotations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnnotationsImpl extends MinimalEObjectImpl.Container implements Annotations
{
  ...
  {
    return OmDslPackage.Literals.ANNOTATIONS;
  }
  ...
  public EList<Annotation> getAnnotations()
  {
    if (annotations == null)
    {
      annotations = new EObjectContainmentEList<Annotation>(Annotation.class, this, OmDslPackage.ANNOTATIONS__ANNOTATIONS);
    }
    return annotations;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case OmDslPackage.ANNOTATIONS__ANNOTATIONS:
